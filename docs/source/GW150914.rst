...
Below we analyse GW150914 (`Phys.Rev.Lett. 116 (2016) 6,061102 <https://doi.org/10.1103/PhysRevLett.116.061102>`_, `Phys.Rev.Lett. 116 (2016) 24,241102 <https://doi.org/10.1103/PhysRevLett.116.241102>`_) through the :code:`simple-pe-pipe` executable. The following script can be used:
